                        ...
                        <div class="main-body">
                            <div class="inner-wrapper">
                                <div class="inner-main-body p-2 p-sm-3 collapse show" id="forum">
                                        ...
                                        <div class="card-body p-2 p-sm-3">
                                            <div class="media forum-item">
                                                <div class="media-body">
                                                    <h6><a href="#forum-1" data-toggle="collapse" data-parent="#forum" class="text-body collapsed">Bug: Scoreboard showing errors</a></h6>
                                    ...
                                    <div id="forum-1" class="inner-main-body p-2 p-sm-3 collapse">
                                        <div class="card mb-2">
                                            <div class="card-body">
                                                <div class="media forum-item">
                                    ...
                                    <div class="card mb-2">
                                        <div class="card-body p-2 p-sm-3">
                                            <div class="media forum-item">
                                                <div class="media-body">
                                                    <h6><a href="#forum-2" data-toggle="collapse" data-parent="#forum" class="text-body collapsed">Issue: Game-Key not working!</a></h6>
                                                    <p class="text-secondary">
                                    ...
                                    <div id="forum-2" class="inner-main-body p-2 p-sm-3 collapse">
                                        <div class="card mb-2">
                                            <div class="card-body">
                                                <div class="media forum-item">
                                                    <div class="media-body ml-3">
                                    ...
                                    <div class="card mb-2">
                                        <div class="card-body p-2 p-sm-3">
                                            <div class="media forum-item">
                                                <div class="media-body">
                                                    <h6><a href="#forum-3" data-toggle="collapse" data-parent="#forum" class="text-body collapsed">Game is unoptimized</a></h6>
                                                    <p class="text-secondary">
                                    ...
                                    <div id="forum-3" class="inner-main-body p-2 p-sm-3 collapse">
                                        <div class="card mb-2">
                                            <div class="card-body">
                                                <div class="media forum-item">
                                                    <div class="media-body ml-3">
                                    ...
                                    <div class="card mb-2">
                                        <div class="card-body p-2 p-sm-3">
                                            <div class="media forum-item">
                                                <div class="media-body">
                                                    <h6><a href="#forum-4" data-toggle="collapse" data-parent="#forum" class="text-body collapsed">[RESOLVED] Bug: Game is crashing</a></h6>
                                                    <p class="text-secondary">
                                    ...
                                    <div id="forum-4" class="inner-main-body p-2 p-sm-3 collapse">
                                        <div class="card mb-2">
                                            <div class="card-body">
                                                <div class="media forum-item">
                                                    <div class="media-body ml-3">
